...
namespace Platformy_Programowania_1.Services
{
    public class YearlyService : IYearlyService
    {
        ...
        public async Task<int> New_Yearly(int company_id)
        {
            ...
            start.Arguments = string.Format("\"{0}\" \"{1}\" \"{2}\" \"{3}\" \"{4}\"", "wwwroot\\scripts\\StockAPI.py", name, DateTime.Now.ToString("yyyy'-'MM'-'dd"), false.ToString().ToLower(), true.ToString().ToLower());
