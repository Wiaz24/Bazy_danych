...
using Platformy_Programowania_1.Migrations;
...
namespace Platformy_Programowania_1.Services
{
    public class DailyService : IDailyService
    {
        ...
        public async Task<int> New_Daily(int id_firmy)
        {
            ...
            start.Arguments = string.Format("\"{0}\" \"{1}\" \"{2}\" \"{3}\" \"{4}\"", "wwwroot\\scripts\\StockAPI.py", name, DateTime.Now.ToString("yyyy'-'MM'-'dd"), true.ToString().ToLower(), true.ToString().ToLower());
